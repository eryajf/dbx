...
<template>
  <main class="fixed inset-0 z-[1000] flex items-center justify-center overflow-y-auto bg-background/95 p-6" role="dialog" aria-modal="true">
    <section class="max-h-[calc(100vh-3rem)] w-full max-w-2xl overflow-y-auto rounded-xl border bg-card p-8 shadow-2xl">
