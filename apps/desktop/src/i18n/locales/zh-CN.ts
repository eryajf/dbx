...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    saveSql: "保存到 SQL 库",
    openSql: "打开 SQL 文件",
    splitQueryVertically: "左右拆分查询编辑器 (Cmd+D)",
    splitQueryHorizontally: "上下拆分查询编辑器 (Cmd+Shift+D)",
    closeQueryPane: "关闭当前拆分窗口",
    theme: "主题",
    themeLight: "亮色",
    themeDark: "暗色",
    themeSystem: "跟随系统",
  ...
  settings: {
    ...
    shortcutSplitQueryVertically: "左右拆分查询",
    shortcutSplitQueryHorizontally: "上下拆分查询",
