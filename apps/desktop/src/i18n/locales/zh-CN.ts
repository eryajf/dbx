...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortMode: "打开表默认排序",
    openTableDefaultSortModeDescription: "控制打开表或刷新数据编辑器时是否自动按主键生成数据库排序；关闭时保持数据库返回顺序。",
    openTableDefaultSortModeNone: "关闭",
    openTableDefaultSortModePrimaryKeyAsc: "主键升序",
    openTableDefaultSortModePrimaryKeyDesc: "主键降序",
    dataGridQuickSort: "表头快速排序默认行为",
    dataGridQuickSortDescription: "控制点击列头排序图标时的默认排序方式，不影响打开表时的数据加载顺序。",
    dataGridQuickSortMode: "排序范围",
    dataGridQuickSortModeDatabase: "数据库排序",
    dataGridQuickSortModeCurrentPage: "当前页排序",
    dataGridQuickSortDirection: "排序方向",
    dataGridQuickSortDirectionAsc: "升序",
    dataGridQuickSortDirectionDesc: "降序",
