...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "启用默认数据排序",
    defaultDataGridSortEnabledDescription: "开启后，打开表数据或点击字段排序图标时使用下方默认排序；默认关闭以保持打开速度。",
    defaultDataGridSortMode: "数据排序默认值",
    defaultDataGridSortModeDescription: "点击字段表头排序图标时，默认使用的排序范围和方向。",
    defaultDataGridSortModeDatabase: "数据库排序",
    defaultDataGridSortModeCurrentPage: "当前页排序",
    defaultDataGridSortDirection: "排序方向",
    defaultDataGridSortDirectionAsc: "升序",
    defaultDataGridSortDirectionDesc: "降序",
