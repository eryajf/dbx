...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "Ativar ordenação padrão",
    defaultDataGridSortEnabledDescription: "Quando ativado, abrir dados da tabela e os ícones de ordenação usam os valores abaixo. Desativado por padrão para abrir tabelas mais rápido.",
    defaultDataGridSortMode: "Ordenação padrão dos dados",
    defaultDataGridSortModeDescription: "Escolha o escopo e a direção padrão ao clicar no ícone de ordenação do cabeçalho.",
    defaultDataGridSortModeDatabase: "Ordenar no banco",
    defaultDataGridSortModeCurrentPage: "Ordenar página atual",
    defaultDataGridSortDirection: "Direção",
