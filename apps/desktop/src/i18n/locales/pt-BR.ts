...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mcpAccessHint: "Esta política gerenciada pelo DBX é definitiva; variáveis do cliente só podem tornar a sessão MCP mais restritiva.",
    mcpAccessDisabled: "Desabilitado",
    mcpAccessReadOnly: "Somente leitura",
    mcpAccessReadWrite: "Leitura e escrita",
  ...
  settings: {
    ...
    mcpScopeConnection: "Escopo de conexão da sessão",
    mcpScopeConnectionDescription: "Opcionalmente limita a configuração MCP gerada às conexões DBX selecionadas. Isso só pode restringir o acesso.",
    mcpScopeAllConnections: "Todas as conexões com MCP habilitado",
    mcpScopeConnectionUnavailable: "Conexão selecionada anteriormente (indisponível)",
    mcpScopeConnectionUnavailableDescription: "{count} conexões selecionadas não existem ou estão com MCP desabilitado. Seus IDs permanecem no escopo até serem desmarcados.",
