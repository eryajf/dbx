...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpHttpStatusLabelNotRunning: "Não está em execução",
    ...
    mcpHttpSaveHint: "Ao salvar, o serviço é iniciado, reiniciado ou parado conforme o interruptor, e as informações de conexão abaixo são atualizadas.",
    mcpHttpApply: "Salvar e aplicar",
