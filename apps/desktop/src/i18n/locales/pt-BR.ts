...
export default withEnglishFallback({
  ...
  history: {
    ...
    title: "Histórico",
    sources: { all: "Tudo", sql: "Consultas SQL", mcp: "Chamadas MCP" },
    refresh: "Atualizar",
    mcp: {
      legacyResponse: "Este registro antigo contém apenas um resumo. A resposta original não pode ser recuperada. Novas chamadas MCP armazenam o conteúdo da resposta.",
      request: "Parâmetros da solicitação",
      response: "Conteúdo da resposta",
      toolSearch: "Filtrar pelo nome da ferramenta MCP...",
    ...
    confirmClearSource: "Limpar todo o histórico de {source}?",
  ...
  settings: {
    ...
    mcpHistoryRetentionLimit: "Retenção do histórico MCP",
    mcpHistoryRetentionDescription: "Controla separadamente a quantidade do histórico de chamadas MCP do histórico SQL.",
    mcpHistoryCleanup: "Limpar histórico MCP agora",
    mcpHistoryCleanupCompleted: "{count} registros do histórico MCP removidos.",
    mcpHistoryCleanupFailed: "Não foi possível limpar o histórico MCP: {error}",
