...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortMode: "Ordenação padrão ao abrir tabela",
    openTableDefaultSortModeDescription: "Controla se abrir uma tabela ou atualizar o editor de dados adiciona ordenação por chave primária no banco. Desativado mantém a ordem retornada pelo banco.",
    openTableDefaultSortModeNone: "Desativado",
    openTableDefaultSortModePrimaryKeyAsc: "Chave primária crescente",
    openTableDefaultSortModePrimaryKeyDesc: "Chave primária decrescente",
    dataGridQuickSort: "Ordenação rápida do cabeçalho",
    dataGridQuickSortDescription: "Controla o comportamento padrão ao clicar no ícone de ordenação de uma coluna, sem alterar como os dados da tabela são carregados.",
    dataGridQuickSortMode: "Escopo",
    dataGridQuickSortModeDatabase: "Ordenar no banco",
    dataGridQuickSortModeCurrentPage: "Ordenar página atual",
    dataGridQuickSortDirection: "Direção",
