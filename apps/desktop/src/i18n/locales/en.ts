export default {
  ...
  toolbar: {
    ...
    splitQueryVertically: "Split query editor vertically (Cmd+D)",
    splitQueryHorizontally: "Split query editor horizontally (Cmd+Shift+D)",
    closeQueryPane: "Close current split pane",
    theme: "Theme",
    themeLight: "Light",
    themeDark: "Dark",
  ...
  settings: {
    ...
    shortcutSplitQueryVertically: "Split query vertically",
    shortcutSplitQueryHorizontally: "Split query horizontally",
