export default {
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "Enable default data sort",
    defaultDataGridSortEnabledDescription: "When enabled, table data opens and column sort icons use the defaults below. Disabled by default to keep table opening fast.",
    defaultDataGridSortMode: "Default data sort",
    defaultDataGridSortModeDescription: "Choose the default sort scope and direction used when clicking a column header sort icon.",
    defaultDataGridSortModeDatabase: "Database sort",
    defaultDataGridSortModeCurrentPage: "Current page sort",
    defaultDataGridSortDirection: "Sort direction",
    defaultDataGridSortDirectionAsc: "Ascending",
    defaultDataGridSortDirectionDesc: "Descending",
