export default {
  ...
  settings: {
    ...
    dataGridQuickSort: "Header quick sort default",
    dataGridQuickSortDescription: "Controls the default behavior when clicking a column header sort icon, without changing how table data loads.",
