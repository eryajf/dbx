export default {
  ...
  connection: {
    ...
    nacosConsoleUrl: "OpenAPI / Admin API URL",
    nacosConsoleUrlHint: "Use the Nacos OpenAPI/admin API address. Nacos 3 Docker usually exposes it on 8085. r-nacos uses its service port 8848 with Context Path /nacos; do not use the new console on 10848 or /rnacos.",
    nacosConsoleUrlRequired: "Nacos OpenAPI / Admin API URL is required",
