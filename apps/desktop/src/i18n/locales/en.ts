export default {
  ...
  connection: {
    ...
    mcpAccessHint: "This DBX-managed policy is authoritative. Client environment variables can only make the MCP session more restrictive.",
    mcpAccessDisabled: "Disabled",
    mcpAccessReadOnly: "Read only",
    mcpAccessReadWrite: "Read and write",
  ...
  settings: {
    ...
    mcpScopeConnection: "Session connection scope",
    mcpScopeConnectionDescription: "Optionally limit the generated MCP config to selected DBX connections. This narrows access but does not override connection policies.",
    mcpScopeAllConnections: "All MCP-enabled connections",
    mcpScopeConnectionUnavailable: "Previously selected connection (unavailable)",
    mcpScopeConnectionUnavailableDescription: "{count} selected connection(s) are missing or MCP-disabled. Their IDs remain scoped until you deselect them.",
    ...
    mcpReadonlyModeDescription: "Adds DBX_MCP_ALLOW_WRITES=0 to the sample config. This can tighten a session but cannot override a DBX-managed connection policy.",
