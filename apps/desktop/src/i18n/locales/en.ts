export default {
  ...
  settings: {
    ...
    syncSecretsSharedDescription: "GitHub Gist and Gitee snippets require this sync password to encrypt the entire snapshot. For WebDAV, it encrypts included secrets.",
