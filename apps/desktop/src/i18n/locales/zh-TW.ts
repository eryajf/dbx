...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mcpAccess: "MCP 存取權限",
    mcpAccessHint: "此策略由 DBX 管理並作為最終限制；用戶端環境變數只能進一步收緊 MCP 工作階段權限。",
    mcpAccessDisabled: "停用",
    mcpAccessReadOnly: "唯讀",
    mcpAccessReadWrite: "讀寫",
    readOnlyBadge: "唯讀",
    proxy: "代理伺服器",
  ...
  settings: {
    ...
    mcpScopeConnection: "工作階段連線範圍",
    mcpScopeConnectionDescription: "可將產生的 MCP 設定限制為多個指定的 DBX 連線。此選項只能收窄範圍，不能覆寫連線本身的 MCP 權限。",
    mcpScopeAllConnections: "所有已啟用 MCP 的連線",
    mcpScopeConnectionUnavailable: "先前選取的連線（無法使用）",
    mcpScopeConnectionUnavailableDescription: "有 {count} 個已選連線不存在或已停用 MCP；取消選取前，其 ID 仍會保留在 scope 中。",
    ...
    mcpReadonlyModeDescription: "開啟後會為範例設定附加 DBX_MCP_ALLOW_WRITES=0。它可以收緊工作階段權限，但不能覆寫 DBX 管理的連線策略。",
