...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortMode: "開啟資料表預設排序",
    openTableDefaultSortModeDescription: "控制開啟資料表或重新整理資料編輯器時，是否自動依主鍵產生資料庫排序；關閉時保留資料庫返回順序。",
    openTableDefaultSortModeNone: "關閉",
    openTableDefaultSortModePrimaryKeyAsc: "主鍵遞增",
    openTableDefaultSortModePrimaryKeyDesc: "主鍵遞減",
    dataGridQuickSort: "表頭快速排序預設行為",
    dataGridQuickSortDescription: "控制點擊欄位表頭排序圖示時的預設排序方式，不影響開啟資料表時的資料載入順序。",
    dataGridQuickSortMode: "排序範圍",
    dataGridQuickSortModeDatabase: "資料庫排序",
    dataGridQuickSortModeCurrentPage: "目前頁排序",
    dataGridQuickSortDirection: "排序方向",
    dataGridQuickSortDirectionAsc: "遞增",
    dataGridQuickSortDirectionDesc: "遞減",
