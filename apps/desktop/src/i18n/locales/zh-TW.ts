...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "啟用預設資料排序",
    defaultDataGridSortEnabledDescription: "開啟後，開啟資料表資料或點擊欄位排序圖示時使用下方預設排序；預設關閉以保持開啟速度。",
    defaultDataGridSortMode: "資料排序預設值",
    defaultDataGridSortModeDescription: "點擊欄位表頭排序圖示時，預設使用的排序範圍和方向。",
    defaultDataGridSortModeDatabase: "資料庫排序",
    defaultDataGridSortModeCurrentPage: "目前頁排序",
    defaultDataGridSortDirection: "排序方向",
    defaultDataGridSortDirectionAsc: "遞增",
    defaultDataGridSortDirectionDesc: "遞減",
