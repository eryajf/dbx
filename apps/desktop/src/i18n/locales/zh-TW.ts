...
export default withEnglishFallback({
  ...
  history: {
    ...
    title: "歷史",
    sources: { all: "全部", sql: "SQL 查詢", mcp: "MCP 呼叫" },
    refresh: "重新整理",
    mcp: { legacyResponse: "此舊記錄僅保存摘要，無法復原原始回應。使用新版 MCP 服務再次呼叫後，即可檢視回應內容。", request: "請求參數", response: "回應內容", toolSearch: "按 MCP 工具名稱篩選……", allTools: "全部工具" },
    search: "搜尋歷史……",
    ...
    confirmClearSource: "確定要清空所有 {source} 歷史記錄嗎？",
  ...
  settings: {
    ...
    mcpHistoryRetentionLimit: "MCP 歷史保留筆數",
    mcpHistoryRetentionDescription: "獨立控制 MCP 呼叫歷史的保留數量，不影響 SQL 查詢歷史。",
    mcpHistoryCleanup: "立即清理 MCP 歷史",
    mcpHistoryCleanupCompleted: "已清理 {count} 筆 MCP 歷史記錄。",
    mcpHistoryCleanupFailed: "無法清理 MCP 歷史：{error}",
