...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "Abilita ordinamento predefinito",
    defaultDataGridSortEnabledDescription: "Se attivo, l'apertura dei dati tabella e le icone di ordinamento usano i valori sotto. Disattivo per impostazione predefinita per aprire le tabelle più rapidamente.",
    defaultDataGridSortMode: "Ordinamento dati predefinito",
    defaultDataGridSortModeDescription: "Scegli ambito e direzione predefiniti usati cliccando l'icona di ordinamento nell'intestazione.",
    defaultDataGridSortModeDatabase: "Ordina nel database",
    defaultDataGridSortModeCurrentPage: "Ordina pagina corrente",
    defaultDataGridSortDirection: "Direzione",
    defaultDataGridSortDirectionAsc: "Crescente",
    defaultDataGridSortDirectionDesc: "Decrescente",
