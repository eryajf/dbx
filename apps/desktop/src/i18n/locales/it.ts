...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mcpAccessHint: "Questa policy gestita da DBX è definitiva; le variabili del client possono solo rendere la sessione MCP più restrittiva.",
    mcpAccessDisabled: "Disabilitato",
    mcpAccessReadOnly: "Sola lettura",
    mcpAccessReadWrite: "Lettura e scrittura",
  ...
  settings: {
    ...
    mcpScopeConnection: "Ambito connessione della sessione",
    mcpScopeConnectionDescription: "Limita facoltativamente la configurazione MCP generata alle connessioni DBX selezionate. Può solo restringere l'accesso.",
    mcpScopeAllConnections: "Tutte le connessioni abilitate per MCP",
    mcpScopeConnectionUnavailable: "Connessione selezionata in precedenza (non disponibile)",
    mcpScopeConnectionUnavailableDescription: "{count} connessioni selezionate non esistono o hanno MCP disabilitato. Gli ID restano nell'ambito finché non vengono deselezionati.",
