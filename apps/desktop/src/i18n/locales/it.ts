...
export default withEnglishFallback({
  ...
  settings: {
    ...
    dataGridQuickSort: "Ordinamento rapido intestazione",
    dataGridQuickSortDescription: "Controlla il comportamento predefinito quando si clicca l'icona di ordinamento di una colonna, senza modificare il caricamento dei dati tabella.",
