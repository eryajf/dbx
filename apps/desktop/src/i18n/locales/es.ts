...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "Activar orden predeterminado",
    defaultDataGridSortEnabledDescription: "Al activarlo, abrir datos de tabla y los iconos de orden usan los valores de abajo. Está desactivado por defecto para abrir tablas más rápido.",
    defaultDataGridSortMode: "Orden predeterminado de datos",
    defaultDataGridSortModeDescription: "Elige el alcance y la dirección predeterminados al hacer clic en el icono de orden del encabezado.",
    defaultDataGridSortModeDatabase: "Ordenar en base de datos",
    defaultDataGridSortModeCurrentPage: "Ordenar página actual",
    defaultDataGridSortDirection: "Dirección",
    defaultDataGridSortDirectionAsc: "Ascendente",
    defaultDataGridSortDirectionDesc: "Descendente",
