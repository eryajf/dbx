...
export default withEnglishFallback({
  ...
  history: {
    ...
    title: "Historial",
    sources: { all: "Todo", sql: "Consultas SQL", mcp: "Llamadas MCP" },
    refresh: "Actualizar",
    mcp: {
      legacyResponse: "Este registro antiguo solo contiene un resumen. No se puede recuperar la respuesta original. Las nuevas llamadas MCP guardan el contenido de la respuesta.",
      request: "Parámetros de solicitud",
      response: "Contenido de respuesta",
      toolSearch: "Filtrar por nombre de herramienta MCP...",
    ...
    confirmClearSource: "¿Borrar todo el historial de {source}?",
  ...
  settings: {
    ...
    mcpHistoryRetentionLimit: "Retención del historial MCP",
    mcpHistoryRetentionDescription: "Controla por separado la cantidad de historial de llamadas MCP del historial SQL.",
    mcpHistoryCleanup: "Limpiar el historial MCP ahora",
    mcpHistoryCleanupCompleted: "Se eliminaron {count} registros del historial MCP.",
    mcpHistoryCleanupFailed: "No se pudo limpiar el historial MCP: {error}",
