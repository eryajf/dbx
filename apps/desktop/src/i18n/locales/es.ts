...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortModeDescription: "Elige el alcance y la dirección predeterminados al abrir datos de tabla o hacer clic en el icono de orden del encabezado.",
