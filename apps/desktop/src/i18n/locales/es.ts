...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpHttpStatusLabelNotRunning: "No ejecutándose",
    ...
    mcpHttpSaveHint: "Al guardar, el servicio se inicia, reinicia o detiene según el interruptor y se actualiza la información de conexión de abajo.",
    mcpHttpApply: "Guardar y aplicar",
