...
export default withEnglishFallback({
  ...
  sqlLibrary: {
    ...
    exportedCount: "Se han importado {count} archivos SQL",
  },
  ...
  diff: {
    ...
    searchDatabase: "Buscar bases de datos...",
    searchSchema: "Buscar esquemas...",
    deployScriptTitle: "Script de implementación",
    deployScriptAllTitle: "Todos los scripts de implementación",
  ...
  settings: {
    ...
    openTableDefaultSortMode: "Orden predeterminado al abrir tabla",
    openTableDefaultSortModeDescription: "Controla si al abrir una tabla o actualizar el editor de datos se agrega ordenación por clave primaria en la base de datos. Desactivado conserva el orden devuelto por la base de datos.",
    openTableDefaultSortModeNone: "Desactivado",
    openTableDefaultSortModePrimaryKeyAsc: "Clave primaria ascendente",
    openTableDefaultSortModePrimaryKeyDesc: "Clave primaria descendente",
    dataGridQuickSort: "Orden rápido del encabezado",
    dataGridQuickSortDescription: "Controla el comportamiento predeterminado al hacer clic en el icono de orden de una columna, sin cambiar cómo se cargan los datos de la tabla.",
    dataGridQuickSortMode: "Alcance",
    dataGridQuickSortModeDatabase: "Ordenar en base de datos",
    dataGridQuickSortModeCurrentPage: "Ordenar página actual",
    dataGridQuickSortDirection: "Dirección",
    dataGridQuickSortDirectionAsc: "Ascendente",
    dataGridQuickSortDirectionDesc: "Descendente",
