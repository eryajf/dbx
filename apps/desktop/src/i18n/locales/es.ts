...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mcpAccessHint: "Esta política administrada por DBX es definitiva; las variables del cliente solo pueden restringir más la sesión MCP.",
    mcpAccessDisabled: "Deshabilitado",
    mcpAccessReadOnly: "Solo lectura",
    mcpAccessReadWrite: "Lectura y escritura",
  ...
  settings: {
    ...
    mcpScopeConnection: "Ámbito de conexión de la sesión",
    mcpScopeConnectionDescription: "Limita opcionalmente la configuración MCP generada a las conexiones DBX seleccionadas. Solo reduce el acceso.",
    mcpScopeAllConnections: "Todas las conexiones con MCP habilitado",
    mcpScopeConnectionUnavailable: "Conexión seleccionada anteriormente (no disponible)",
    mcpScopeConnectionUnavailableDescription: "Faltan {count} conexiones seleccionadas o tienen MCP deshabilitado. Sus ID permanecen en el ámbito hasta que se desmarquen.",
