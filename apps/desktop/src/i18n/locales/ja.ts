...
export default withEnglishFallback({
  ...
  history: {
    ...
    title: "履歴",
    sources: { all: "すべて", sql: "SQL クエリ", mcp: "MCP 呼び出し" },
    refresh: "更新",
    mcp: { legacyResponse: "この旧記録には概要のみが含まれます。元の応答は復元できません。更新後の MCP サービスでは応答内容が保存されます。", request: "リクエストパラメーター", response: "応答内容", toolSearch: "MCP ツール名で絞り込み...", allTools: "すべてのツール" },
    search: "履歴を検索...",
    ...
    confirmClearSource: "{source} の履歴をすべて消去しますか？",
  ...
  settings: {
    ...
    mcpHistoryRetentionLimit: "MCP 履歴の保持数",
    mcpHistoryRetentionDescription: "SQL 履歴とは別に MCP 呼び出し履歴の保持数を管理します。",
    mcpHistoryCleanup: "MCP 履歴を今すぐ消去",
    mcpHistoryCleanupCompleted: "MCP 履歴を {count} 件削除しました。",
    mcpHistoryCleanupFailed: "MCP 履歴を消去できませんでした: {error}",
