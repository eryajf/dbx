...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortMode: "テーブルを開くときの既定の並び替え",
    openTableDefaultSortModeDescription: "テーブルを開く、またはデータエディターを更新するときに主キーでデータベース並び替えを追加するかを制御します。無効の場合はデータベースの戻り順を維持します。",
    openTableDefaultSortModeNone: "無効",
    openTableDefaultSortModePrimaryKeyAsc: "主キー昇順",
    openTableDefaultSortModePrimaryKeyDesc: "主キー降順",
    dataGridQuickSort: "ヘッダーのクイック並び替え既定動作",
    dataGridQuickSortDescription: "列ヘッダーの並び替えアイコンをクリックしたときの既定動作を制御します。テーブルデータの読み込み順には影響しません。",
    dataGridQuickSortMode: "並び替え範囲",
    dataGridQuickSortModeDatabase: "データベースで並び替え",
    dataGridQuickSortModeCurrentPage: "現在のページで並び替え",
    dataGridQuickSortDirection: "並び替え方向",
    dataGridQuickSortDirectionAsc: "昇順",
    dataGridQuickSortDirectionDesc: "降順",
