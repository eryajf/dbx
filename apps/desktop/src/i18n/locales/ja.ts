...
export default withEnglishFallback({
  ...
  settings: {
    ...
    defaultDataGridSortEnabled: "既定のデータ並び替えを有効化",
    defaultDataGridSortEnabledDescription: "有効にすると、テーブルデータを開くときや列の並び替えアイコンをクリックしたときに下の既定値を使います。既定では高速に開くため無効です。",
    defaultDataGridSortMode: "既定のデータ並び替え",
    defaultDataGridSortModeDescription: "列ヘッダーの並び替えアイコンをクリックしたときに使う既定の範囲と方向を選択します。",
    defaultDataGridSortModeDatabase: "データベースで並び替え",
    defaultDataGridSortModeCurrentPage: "現在のページで並び替え",
    defaultDataGridSortDirection: "並び替え方向",
    defaultDataGridSortDirectionAsc: "昇順",
    defaultDataGridSortDirectionDesc: "降順",
