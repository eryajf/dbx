...
| r-nacos | `rnacos/0.8` | `rnacos/rnacos:v0.8.5` | `docker.cnb.cool/znb/images/rnacos:v0.8.5` | `8849` | `dbx-rnacos-0.8` |
...
r-nacos uses the `admin` administrator and password `123456`. Its HTTP, gRPC, and web-console ports default to `8849`, `9849`, and `10849`. To use the port mapping from the standalone Compose command, run:
