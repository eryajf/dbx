...
mod tests {
    #[cfg(target_os = "macos")]
    use super::development_dock_badge_label;
    use super::{
...
pub fn run() {
    ...
    builder
        .setup(move |app| {
            ...
            let pubsub_server_port =
                tauri::async_runtime::block_on(commands::redis_pubsub_server::start_pubsub_server(state.clone()))?;
            app.manage(pubsub_server_port);
